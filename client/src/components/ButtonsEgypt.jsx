    ...
    <>
      <div className="floating-buttons">
        ...
        <div className="icon-container" onClick={togglePopup}>
         <img src="/img/bottonicircolari/imprevisto_egitto.png" alt="imprevisto_egitto" className="floating-button" />
        </div>

        {/* Secondo bottone - Naviga a /map */}
        <div className="icon-container" onClick={() => navigate("/map")}>
          <img src="/img/bottonicircolari/mappa_egitto.png" alt="mappa_egitto" className="floating-button" />
        </div>

        {/* Terzo bottone - Placeholder per future funzioni */}
        <div className="icon-container">
          <img src="/img/bottonicircolari/info_egitto.png" alt="info_egitto" className="floating-button" />
        </div>
      </div>
